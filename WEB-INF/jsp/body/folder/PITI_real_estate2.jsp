...
<script language="JavaScript" type="text/javascript">
	...
	function dosum2(YR, LA) {
		...
		document.temps.PI.value = floor(LA * mi / (1 - (1 / base)))
		document.temps.MT.value = floor(document.temps.AT.value / 12)
		document.temps.MI.value = floor(document.temps.AI.value / 12)
		var dasum = LA * mi / (1 - (1 / base)) + document.temps.AT.value / 12
	...
	$(function() {
		...
		$('#getCompare').on('click', function(){
		/* 	var years = ['30', '25', '20', '15'];
			var loanAmounts = ['80990','85990','90990','95990','100990','105990','110990','120990','125990','130990','135990','140990','145990','150990'];
			var LA = document.temps.LA.value;
			var tbody = $('tbody');
			tbody.html('');
			var flag = '1';
			$.each( loanAmounts, function(k, la){
				var tr = $('<tr>');
				if ( flag === '1'){
					tr.addClass('info');
					flag = '0';
...
<body>
			...
			<form name="temps">
				...
				<div class="col-xs-18 col-sm-12 col-md-12 row">
					<div class="form-group form-element col-xs-18 col-sm-4 col-md-4">
						<span class="label control-label">Years:</span> <input type="text"
							name="YR" SIZE="6" VALUE="30" class="form-control" />
					</div>
					<div class="form-group form-element col-xs-18 col-sm-4 col-md-4">
						<span class="label control-label">Interest Rate:</span> <input
							type="text" name="IR" SIZE="6" VALUE="9.5" class="form-control" />
					</div>
					<div class="form-group form-element col-xs-18 col-sm-4 col-md-4">
						<span class="label control-label">Loan Amount:</span> <input
							type="text" name="LA" SIZE="6" VALUE="100000"
							class="form-control" />
					</div>
				</div>
				<div class="col-xs-18 col-sm-12 col-md-12 row">
					<div class="form-group form-element col-xs-18 col-sm-4 col-md-4">
						<span class="label control-label">Annual Tax:</span> <input
							type="text" name="AT" SIZE="6" VALUE="1000" class="form-control" />
					</div>
					<div class="form-group form-element col-xs-18 col-sm-4 col-md-4">
						<span class="label control-label">Annual Insurance:</span> <input
							type="text" name="AI" SIZE="6" VALUE="300" class="form-control" />
					</div>
					<div class="form-group form-element col-xs-18 col-sm-4 col-md-4">
 ...
 -->
			...
			<div id="result">
				<button id="getCompare" class="btn btn-primary">Compare Payment Base On Number Of Years</button>
			</div>
			<div class="col-xs-18 col-sm-12 col-md-12">
			<table id="tblCompare" class="table table-hover table-inverse table-bordered">
					<colgroup>
					</colgroup>
					<thead>
						<tr class="danger">
