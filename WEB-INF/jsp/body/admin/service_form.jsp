		...
		<div class="blog-form-wraper container">
			<div class="row">
				<div class="page-header col-xs-18 col-sm-12 col-md-12">
					<h3>Please, Input Service Information</h3>
				</div>
			</div>
			<div class="row  form-group">
				<div class="col-md-3 col-sm-3 col-xs-9">
					<span class="label control-label">Service Name:</span>
				</div>
			...
			<div class="row  form-group">
				<div class="col-md-3 col-sm-3 col-xs-9">
					<span class="label control-label">Service Sub-Content:</span>
				</div>
				<div class="col-md-9 col-sm-9 col-xs-9">

					<textarea rows="5" cols="50" name="serviceSubContent"
						class="form-control" id="service-sub-content"></textarea>
				</div>
			...
			<div class="row  form-group">
				<div class="col-md-3 col-sm-3 col-xs-9">
					<span class="label control-label">Service Content:</span>
				</div>
				<div class="col-md-9 col-sm-9 col-xs-9">

					<textarea name="serviceContent" class="form-control" id="serviceContent"></textarea>
				</div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="<c:url value='/admin/services' />"><button type="button" class="btn btn-default">GoTo Service</button></a>
			</div>
		</div>
	</div>
</div>
...
<script type="text/javascript"
	src='<c:url value="/resources/js/admin/service_form.js"/>'></script>